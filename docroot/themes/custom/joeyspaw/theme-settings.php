 ...
 */
function joeyspaw_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['joeyspaw_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('joeyspaw sample setting'),
  '#default_value' => theme_get_setting('joeyspaw_example'),
